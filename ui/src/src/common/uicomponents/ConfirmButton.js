...
export class ConfirmButton extends SubComponent {
    ...
    render() {
        return (
            <div>
            <a type="button" className={this.state.buttonClass} data-toggle="modal" data-target={"#confirmation-"+this.state.componentId}>{this.state.buttonText}</a>
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        <a type="button" className={this.state.buttonClass} data-dismiss="modal" onClick={e => this.handleSubmit(e)}>{this.state.buttonText}</a>
                    </div>
                </div>
            </div>
        </div>
